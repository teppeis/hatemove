...
declare module chrome.bookmarks {
    ...
    export var onRemoved: chrome.alarms.AlarmEvent;
...
declare module chrome.extension {
    ...
    export var onMessageExternal: ExtensionMessageExternalEvent;
    export var onConnect: ExtensionConnectEvent;
    export var onConnectExternal: ExtensionConnectExternalEvent;
}
...
declare module chrome.runtime {
    ...
    export var onSuspend: RuntimeSuspendEvent;
    export var onStartup: RuntimeStartupEvent;
    export var onInstalled: RuntimeInstalledEvent;
    export var onSuspendCanceled: RuntimeSuspendCanceledEvent;
}
...
declare module chrome.ttsEngine {
    ...
    export var onStop: TtsEngineStopEvent;
}
...
declare module chrome.webNavigation {
    ...
    export var onReferenceFragmentUpdated: WebNavigationReferenceFragmentUpdatedEvent;
    export var onCompleted: WebNavigationCompletedEvent;
    export var onHistoryStateUpdated: WebNavigationHistoryStateUpdatedEvent;
    export var onCreatedNavigationTarget: WebNavigationCreatedNavigationTargetEvent;
    export var onTabReplaced: WebNavigationTabReplacedEvent;
    export var onBeforeNavigate: WebNavigationBeforeNavigateEvent;
    export var onCommitted: WebNavigationCommittedEvent;
    export var onDOMContentLoaded: WebNavigationDomContentLoadedEvent;
    export var onErrorOccurred: WebNavigationErrorOccurredEvent;
}
...
declare module chrome.webRequest {
    ...
    export var onCompleted: WebRequestCompletedEvent;
    export var onHeadersReceived: WebRequestHeadersReceivedEvent;
    export var onBeforeRedirect: WebRequestBeforeRedirectEvent;
    export var onAuthRequired: WebRequestAuthRequiredEvent;
    export var onBeforeSendHeaders: WebRequestBeforeSendHeadersEvent;
    export var onErrorOccurred: WebRequestErrorOccurredEvent;
    export var onResponseStarted: WebRequestResponseStartedEvent;
    export var onSendHeaders: WebRequestSendHeadersEvent;
    export var onBeforeRequest: WebRequestBeforeRequestEvent;
}
...
declare module chrome.windows {
    ...
    export var onRemoved: WindowRemovedEvent;
    export var onCreated: WindowCreatedEvent;
    export var onFocusChanged: WindowFocusChangedEvent;
}
